...
// ----- Obtendo o score e as sequências alinhadas ----- //
    ...
    for (auto& sub_a : subseqs_a){
        for (auto& sub_b : subseqs_b){
            ...
            if (sw_atual.item_score>max_score){
                max_score = sw_atual.item_score;
                melhor.item_score =sw_atual.item_score;
                melhor.seq_a = sw_atual.seq_a;
                melhor.seq_b = sw_atual.seq_b;
            }
...
// g++ -Wall -O3 p3_smith_waterman.cpp -o p3_smith_waterman
// ./p3_smith_waterman < dna.seq